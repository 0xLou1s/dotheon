...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Learn more about Dotheon and our mission to revolutionize yield farming.",
};
  ...
  return (
    <div className="min-h-screen text-justify">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">About Dotheon</h1>

        <div className="prose prose-lg max-w-none">
          <p className="text-gray-600 mb-6">
            Dotheon is at the forefront of decentralized finance, dedicated to
            making yield farming accessible and efficient for everyone. Our
          ...
          <p className="text-gray-600 mb-6">
            At Dotheon, we provide automated yield farming strategies that adapt
            to market conditions, ensuring optimal returns for our users. Our
            platform combines cutting-edge technology with rigorous security
