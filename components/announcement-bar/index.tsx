...
export default function AnnouncementBar() {
  return (
    <div className="relative flex items-center justify-between bg-foreground mb-2 px-6 py-[0.60rem] rounded-md text-[0.5rem] font-normal leading-5 text-primary-foreground lg:text-xs">
      <StartHighlight />
